				...
				<div class="row no-m-t no-m-b">
                        <div class="col s12 m12 l8">
						 ...
						 <div class="card-content">
                                <span class="card-title">Add Products - Register Your Products (eg: Wrench, Combination Wrench)</span><br>
                                <div class="row">
                                    <form class="col s12" id="add_stocks">
                                        <div class="row">
                                            ...
                                            <div class="input-field col s6 tooltipped"  data-position="bottom" data-delay="50" data-tooltip="Threshold will give you a notification whenever your product stock reaches to this level.">
											...
											<input type="hidden" name="stock_type" value="final">
