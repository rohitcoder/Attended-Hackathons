				...
				<div class="row no-m-t no-m-b">
                        <div class="col s6 m6 l6">
						 ...
						 <div class="card-content">
                                <span class="card-title">Overall Monthly Revenue from your Products.</span><br>
                                <div class="row">
								<!-- Delete it later on no use -->
								   <div id="expense_raw_stocks" style="height: 300px; width: 100%;display:none;"></div>
								   <div id="expense_raw_this_month" style="height: 300px; width: 100%;display:none;"></div>
                                   <div id="consume_raw_this_month" style="height: 300px; width: 100%;display:none;"></div>
								<!-- Till here -->
                                   <div id="expense_final_stocks" style="height: 300px; width: 100%;"></div>
                                </div>
                            </div>
						 </div>
                        </div>
                         ...
                         <div class="card">
						 <div class="card-content">
                                <span class="card-title">Monthly Revenue from your each product.</span><br>
                                <div class="row">
                                   <div id="expense_final_this_month" style="height: 300px; width: 100%;"></div>
                                </div>
                            </div>
						 </div>
                        </div>
						 ...
						 <div class="card-content">
                                ...
                                <div class="row">
                                   <div id="consume_final_this_month" style="height: 300px; width: 100%;"></div>
                                </div>
                            </div>
						 </div>
                        </div>
                                ...
                                <table class="responsive-table bordered">
									...
									foreach($sales_orders as $sales){?>
                                        <tr>
                                            ...
                                            <td><b><?php echo GetQuantityOfStock($sales['stock_id'],'final');?> Units</b></td>
